...
quantum antimatter fuel injection system for her LAMBCHOP doomsday device. 
...
one pellet at a time. However, minions dump pellets in bulk into the fuel 
intake. You need to figure out the most efficient way to sort and shift the 
...
energy released when a quantum antimatter pellet is cut in half, the safety controls 
...
the number of pellets to 1. The fuel intake control panel can only display 
a number up to 309 digits long, so there won't ever be more pellets than 
